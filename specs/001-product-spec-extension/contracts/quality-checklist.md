...
This file is the **canonical product spec quality checklist**. Every product spec generated by `/speckit-product-spec` is paired with a `checklists/product.md` file populated from this template. The checklist verifies that the generated artifact follows the canonical structure, the canonical style, and the canonical content rules.
