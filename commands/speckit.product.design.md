...
| Diagrams present when section warrants                 | Each section with source content has its `mermaid` diagram; each diagram sits in a section with real source content; no placeholder labels (`ENTITY_A`, `Part name`)                                                | Yes - add diagram or fill from source                                 |
