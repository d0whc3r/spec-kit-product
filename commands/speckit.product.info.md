...
- **Mandatory sections (Overview, What is Changing, Out of Scope)**: always present, in canonical order, populated. If the source spec lacks information for a mandatory section, do NOT fabricate. Populate the section with what is known, and add a precise question to the Key Decisions "Still open" block.
...
- **Overview**: one short paragraph, two to four sentences. State who this is for, the problem it addresses, what changes for them, and the new outcome they can reach. No jargon, no implementation detail, no feature lists.
...
| Sections in canonical order                                       | Headings appear in sequence: Overview, What is Changing, Out of Scope, [Risks], [Key Decisions], [References] - brackets indicate optional                                                                                                                                       | Yes - reorder                                                                                    |
...
Sections populated: Overview + What is Changing + Out of Scope[, Risks][, Key Decisions (<M> decisions[, <N> still open])][, References]
